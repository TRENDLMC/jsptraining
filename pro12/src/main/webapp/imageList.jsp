...
<title>이미지리스트창</title>
 ...
 <style>
    ...
    list-style: none; border-bottom: 2px solid lightgray; position: relative;}
        .lst_type img{display: inline; float: left; position: absolute;}
        .lst_type a{color: #2d2c2d; text-decoration: none; margin-left: 340px;}
...
<body>
  <ul class="lst_type">
        <li>
            <span style="margin-left: 80px;">이미지</span>
            <span style="margin-left: 280px;">이미지이름</span>
            <span>선택하기</span>
        </li>
        <%
        for(int i=0;i<10; i++){
